...
JM.demarrerJeuGrille({
  ...
  textes: {
    fr: {
      ...
      confirmerFinTitre: 'Terminer maintenant ?',
      confirmerFinTexte: 'Le chrono s’arrête et la partie est close : vous ne pourrez plus ajouter de mot.',
      continuer: 'Continuer à jouer',
      voirResultat: 'Voir mon résultat',
      confirmerEffacementTitre: 'Effacer vos données ?',
      confirmerEffacement: 'La partie en cours et vos scores seront supprimés de cet appareil.',
      annuler: 'Annuler',
      effacer: 'Effacer',
      casePasVoisine: 'Les lettres doivent se toucher',
      caseDejaUtilisee: 'Cette case est déjà prise dans le mot',
      ...
      partage: function (d) {
        return [
          `Grille de lettres n°${d.numero} — ${d.score} points`,
          `${d.barre} cible ${d.cible}`,
          `${d.mots} mots sur ${d.total}`,
        ];
      },
    },
  },
